globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/projects/nuxt-examples-suakka/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file:///home/projects/nuxt-examples-suakka/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///home/projects/nuxt-examples-suakka/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/projects/nuxt-examples-suakka/node_modules/devalue/index.js';
import { renderToString } from 'file:///home/projects/nuxt-examples-suakka/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/projects/nuxt-examples-suakka/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/projects/nuxt-examples-suakka/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/projects/nuxt-examples-suakka/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/projects/nuxt-examples-suakka/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/projects/nuxt-examples-suakka/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///home/projects/nuxt-examples-suakka/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/projects/nuxt-examples-suakka/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/projects/nuxt-examples-suakka/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///home/projects/nuxt-examples-suakka/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/projects/nuxt-examples-suakka/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/projects/nuxt-examples-suakka/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/projects/nuxt-examples-suakka/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/projects/nuxt-examples-suakka/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/projects/nuxt-examples-suakka","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/projects/nuxt-examples-suakka/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/projects/nuxt-examples-suakka/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/projects/nuxt-examples-suakka/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _8peL1vd6ZF = (function(nitro) {
...
const _lazy_Y6Gmu6 = () => Promise.resolve().then(function () { return hello$1; });
const _lazy_8tPYRI = () => Promise.resolve().then(function () { return base$1; });
const _lazy_6WTzGK = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/hello', handler: _lazy_Y6Gmu6, lazy: true, middleware: false, method: undefined },
  { route: '/api/base', handler: _lazy_8tPYRI, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_6WTzGK, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_6WTzGK, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/home/projects/nuxt-examples-suakka/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/projects/nuxt-examples-suakka/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
